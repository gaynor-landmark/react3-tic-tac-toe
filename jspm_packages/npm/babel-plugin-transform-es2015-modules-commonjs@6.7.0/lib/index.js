              ...
              if (specifiers.length) {
                ...
                if (source) {
                  ...
                  for (var _iterator6 = specifiers,
                    ...
                    var specifier = _ref6;
                    if (specifier.isExportNamespaceSpecifier()) {} else if (specifier.isExportDefaultSpecifier()) {} else if (specifier.isExportSpecifier()) {
